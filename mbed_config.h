...
#define CLOCK_SOURCE                                                          USE_PLL_MSI                                                                                      // set by target:NUCLEO_L433RC_P
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:NUCLEO_L433RC_P
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:NUCLEO_L433RC_P
