...
OBJECTS += ./mbed-os/features/cellular/framework/targets/MultiTech/DragonflyNano/PPP/SARA4_PPP_CellularContext.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/M26/QUECTEL_M26_CellularNetwork.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/M26/QUECTEL_M26_CellularPower.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/M26/QUECTEL_M26_CellularSIM.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/HE910/TELIT_HE910_CellularContext.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/UBLOX/PPP/UBLOX_PPP_CellularContext.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/TARGET_NUCLEO_L433RC_P/PeripheralPins.o
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/TARGET_NUCLEO_L433RC_P/system_clock.o
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/device/TOOLCHAIN_GCC_ARM/startup_stm32l433xx.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/l4_retarget.o
...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/TARGET_NUCLEO_L433RC_P
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/device
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/device
INCLUDE_PATHS += -I..//home/danbot/Dropbox/LDL/ExpansionGuard/Firmware/mbed-os-guardian/mbed-os

LIBRARY_PATHS :=
LIBRARIES :=
LINKER_SCRIPT ?= .././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/device/TOOLCHAIN_GCC_ARM/STM32L433XX.ld
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1554599239.63
...
C_FLAGS += -DTARGET_NUCLEO_L433RC_P
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1554599239.63
...
CXX_FLAGS += -DTARGET_NUCLEO_L433RC_P
...
ASM_FLAGS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC
ASM_FLAGS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/TARGET_NUCLEO_L433RC_P
ASM_FLAGS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L433xC/device
ASM_FLAGS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/device
ASM_FLAGS += -I..//home/danbot/Dropbox/LDL/ExpansionGuard/Firmware/mbed-os-guardian/mbed-os
ASM_FLAGS += -include
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DMBED_ROM_START=0x8000000 -DMBED_ROM_SIZE=0x40000 -DMBED_BOOT_STACK_SIZE=1024 
